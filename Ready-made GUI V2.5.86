...
local Utility = {}
local Objects = {}
function Vex:DraggingEnabled(frame, parent)
...
local themeStyles = {
    ...
    -- 10
    Ember = {
        SchemeColor = Color3.fromRGB(255, 120, 40),
        Background = Color3.fromRGB(30, 18, 12),
        Header = Color3.fromRGB(45, 25, 15),
        TextColor = Color3.fromRGB(255, 230, 200),
        ElementColor = Color3.fromRGB(55, 30, 18)
    },

    -- 11
    Frost = {
        SchemeColor = Color3.fromRGB(120, 220, 255),
        Background = Color3.fromRGB(18, 24, 32),
        Header = Color3.fromRGB(28, 36, 46),
        TextColor = Color3.fromRGB(220, 240, 255),
        ElementColor = Color3.fromRGB(36, 46, 58)
    },
    ...
    Sunset = {
        ...
        Background = Color3.fromRGB(45, 24, 36),
        Header = Color3.fromRGB(60, 32, 48),
        TextColor = Color3.fromRGB(255, 220, 220),
        ElementColor = Color3.fromRGB(70, 40, 55)
    },
    ...
    Royal = {
        ...
        Header = Color3.fromRGB(30, 35, 65),
        TextColor = Color3.fromRGB(255,255,255),
        ElementColor = Color3.fromRGB(40, 45, 80)
    },

    -- 15
    Emerald = {
        SchemeColor = Color3.fromRGB(0, 201, 87),
        Background = Color3.fromRGB(18, 36, 28),
        Header = Color3.fromRGB(25, 50, 38),
        TextColor = Color3.fromRGB(220,255,240),
        ElementColor = Color3.fromRGB(30, 60, 45)
    },

    -- 16
    Lavender = {
        SchemeColor = Color3.fromRGB(181, 126, 220),
        Background = Color3.fromRGB(45, 40, 60),
        Header = Color3.fromRGB(60, 52, 80),
        TextColor = Color3.fromRGB(240, 230, 255),
        ElementColor = Color3.fromRGB(75, 65, 95)
    },

    -- 17
    Steel = {
        SchemeColor = Color3.fromRGB(120, 130, 140),
        Background = Color3.fromRGB(25, 28, 32),
        Header = Color3.fromRGB(35, 40, 46),
        TextColor = Color3.fromRGB(220,220,220),
        ElementColor = Color3.fromRGB(45, 50, 58)
    },
    ...
    Candy = {
        ...
        Header = Color3.fromRGB(70, 35, 55),
        TextColor = Color3.fromRGB(255, 240, 250),
        ElementColor = Color3.fromRGB(85, 45, 65)
    },
    ...
    Cyber = {
        ...
        Header = Color3.fromRGB(18, 26, 32),
        TextColor = Color3.fromRGB(180, 255, 255),
        ElementColor = Color3.fromRGB(25, 35, 42)
    },

    -- 20
    CrimsonNight = {
        SchemeColor = Color3.fromRGB(170, 0, 40),
        Background = Color3.fromRGB(20, 0, 10),
        Header = Color3.fromRGB(35, 0, 18),
        TextColor = Color3.fromRGB(255, 220, 220),
        ElementColor = Color3.fromRGB(45, 5, 22)
    },

    -- 21
    Arctic = {
        SchemeColor = Color3.fromRGB(200, 240, 255),
        Background = Color3.fromRGB(220, 235, 245),
        Header = Color3.fromRGB(200, 220, 235),
        TextColor = Color3.fromRGB(40, 60, 80),
        ElementColor = Color3.fromRGB(210, 230, 245)
    },

    -- 22
    Obsidian = {
        SchemeColor = Color3.fromRGB(90, 0, 120),
    ...
    -- 23
    Solar = {
        SchemeColor = Color3.fromRGB(255, 170, 0),
        Background = Color3.fromRGB(40, 28, 10),
        Header = Color3.fromRGB(60, 40, 15),
        TextColor = Color3.fromRGB(255, 240, 200),
        ElementColor = Color3.fromRGB(75, 50, 20)
    },

    -- 24
    Matrix = {
        SchemeColor = Color3.fromRGB(0, 255, 120),
        Background = Color3.fromRGB(5, 15, 5),
        Header = Color3.fromRGB(10, 25, 10),
        TextColor = Color3.fromRGB(180,255,180),
        ElementColor = Color3.fromRGB(15, 35, 15)
    }
}
...
function Vex.CreateLib(kavName, themeList)
    ...
    Vex:DraggingEnabled(MainHeader, Main)
    ...
    function Vex:ChangeColor(prope,color)
...
local function SetBackgroundTransparency(guiObject, value)
	for _, v in ipairs(guiObject:GetDescendants()) do
...
for i = 0, 2 do
	...
	line.Size = UDim2.fromOffset(12 - (i * 3), 2)
	line.Position = UDim2.new(1, -14 + (i * 4), 1, -6 - (i * 4))
